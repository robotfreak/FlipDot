...
struct gameInitializer gi[9] = {
  ...
  {5, 7, 40, 1,   "0011000000"},
  {5, 8, 40, 1,   "000C000000"}
  //{1, 1, 40, 9,   "00000080000000028000000C0C003000110C0030C0208C0000C020C2000000208080000011008000000C000000"}
};
...
void golSetup() {
  ...
  // Display Arduino GoL splashscreen
...
*/
  ...
  for(gidx=0; gidx<9; gidx++) {
    initGameBoard(gidx, gi[gidx].xOffs, gi[gidx].yOffs, 
                gi[gidx].xSize, gi[gidx].ySize,
                gi[gidx].s);
  }

 
//    initGameBoard(i, gi[gidx].xOffs, gi[gidx].yOffs, 
//                gi[gidx].xSize, gi[gidx].ySize,
//                gi[gidx].s);
...
//===========================================
int initGameBoard(int mode, int xOffs, int yOffs, int xSize, int ySize, const char *s)
//void initGameBoard()
{
